...
class Meeting(Base):
    ...
    meeting_type = Column(String, nullable=False)  # e.g., "city_council", "committee", "public_hearing"
...
class AgendaItem(Base):
    ...
    title = Column(String, nullable=False)
    description = Column(Text, nullable=True)
    item_type = Column(String, nullable=True)  # e.g., "ordinance", "resolution", "presentation"
