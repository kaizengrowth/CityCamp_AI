    ...
    <div className="space-y-8">
      ...
      <div className="bg-blue-50 rounded-xl p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-blue-800">
          <div>
            <h3 className="font-medium mb-2 text-sm">🗳️ Local Representation</h3>
            <p className="text-sm">
          ...
          <div>
            <h3 className="font-medium mb-2 text-sm">📢 Direct Communication</h3>
            <p className="text-sm">
          ...
          <div>
            <h3 className="font-medium mb-2 text-sm">📊 Informed Voting</h3>
            <p className="text-sm">
          ...
          <div>
            <h3 className="font-medium mb-2 text-sm">🤝 Community Engagement</h3>
            <p className="text-sm">
      ...
      <div className="bg-gray-50 rounded-xl p-6">
        ...
        <div className="space-y-3">
          ...
          >
            <h3 className="font-medium text-brand-dark-blue text-sm">Tulsa City Council Website</h3>
          ...
          <a
            ...
            className="block p-3 bg-white rounded-lg border hover:border-blue-300 transition-colors"
          >
            <h3 className="font-medium text-brand-dark-blue text-sm">Official District Map</h3>
            <p className="text-sm text-gray-600">
          ...
          <a
            ...
            className="block p-3 bg-white rounded-lg border hover:border-blue-300 transition-colors"
          >
            <h3 className="font-medium text-brand-dark-blue text-sm">AI Email Composer</h3>
            <p className="text-sm text-gray-600">
